local local_plugins = {
    {
        ...
        config = function()
            ...
            vim.keymap.set("n", "<leader><C-t>", function() mark.replace_file(2) end) -- Replace file 2 with current
            vim.keymap.set("n", "<leader><C-n>", function() mark.replace_file(3) end) -- Replace file 3 with current
            vim.keymap.set("n", "<leader><C-s>", function() mark.replace_file(4) end) -- Replace file 4 with current
        end
    },
}
